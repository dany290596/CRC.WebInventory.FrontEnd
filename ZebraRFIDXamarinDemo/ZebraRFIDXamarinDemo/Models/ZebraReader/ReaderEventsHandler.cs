...
namespace XamarinZebraRFIDSample.ZebraReader
{
    internal class ReaderEventsHandler : Java.Lang.Object, IRfidEventsListener
    {
        ...
        public EventHandler<ZebraRFIDXamarinDemo.Models.Tag.TagReadData> ReaderTagDataEventOutput { get; set; }
        ...
        public void EventReadNotify(RfidReadEvents e)
        {
            ...
            if (readTags != null)
            {
                ...
                foreach (var tagKey in tagReadGroup.Keys)
                {
                    ...
                    var myTag = new ZebraRFIDXamarinDemo.Models.Tag.TagReadData();
