...
{
    public class Scanner : Java.Lang.Object, Com.Zebra.Scannercontrol.IDcsSdkApiDelegate
    {
        private static Scanner _scannerModel;
        ...
        private static Reader rfid = Reader.readerModel;
        ...
        public static Scanner scannerModel
        {
            get
            {
                if (_scannerModel == null)
                    _scannerModel = new Scanner();
