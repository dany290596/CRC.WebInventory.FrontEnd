...
{
    public class Reader : Java.Lang.Object, Com.Zebra.Rfid.Api3.Readers.IRFIDReaderEventHandler, IRfidEventsListener, IWifiScanDataEventsListener
    {
        private static Reader _ReaderModel;
        ...
        public static Reader readerModel
        {
            get
            {
                if (_ReaderModel == null)
                    _ReaderModel = new Reader();
                return _ReaderModel;
            }
        }
